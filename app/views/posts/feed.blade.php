            ...
            <div class="row">
                <div class="features">
                    ...
                    <div class="col-md-6 col-sm-6 wow" data-wow-duration="1000ms" data-wow-delay="600ms">
                        ...
                        <a href="/posts/feed/{{ $item->id }}" title="Open Discussion Feed" class="btn btn-selected">Read Posts</a>
                        
                        <h2 class="margin_top_40">
                        Recent Discussion Posts
			<!-- handling plural wording of Post / Posts -->
			@if($post_count == 1)
			<span class="light_gray_font pull-right"> {{ number_format($post_count) }}  Post</span>
			@else
			<span class="light_gray_font pull-right"> {{ number_format($post_count) }}  Posts</span>
			@endif
