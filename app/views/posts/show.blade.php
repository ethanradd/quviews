...
@section('content')
    ...
    <section id="recent-works">
            ...
            <div class="row">
                <div class="features">
                    ...
                    <div class="col-md-6 col-sm-6 wow" data-wow-duration="1000ms" data-wow-delay="600ms">
                        ...
                        <h2 class="margin_top_40">Post by {{ $post->username }}</h2>
			...
			@if($reply_count == 1)
			<h2 class="light_gray_font">Replies <span class="light_gray_font pull-right"> {{ number_format($reply_count) }} reply</span></h2>
			@else($reply_count > 1)
			<h2 class="light_gray_font">Replies <span class="light_gray_font pull-right"> {{ number_format($reply_count) }} replies</span></h2>
			@endif
			...
			<div id="feed_line">
			  ...
			  <span class="light_gray_font pull-right">
				...
				@endif
                          ...
                          <span class="light_gray_font pull-right">. &nbsp;</span>
                          <span class="light_gray_font pull-right"><a href="/replies/create/{{ $post->id }}/{{ $reply->id }}">Quote &nbsp; </a></span>
			...
			<!-- Do Nothing -->
                        ...
                        <p class="light_gray_font"><b>No replies yet</b></p>
                        @endif
