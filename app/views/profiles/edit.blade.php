            ...
            <div class="row">
                <div class="features">
                    <div class="col-md-4 col-sm-6 wow" data-wow-duration="1000ms" data-wow-delay="600ms">
                        ...
                        <a class="btn btn-primary" href="/profiles/remove-profile-image/{{ $profile->id }}" onclick="return confirm('Are you sure?')">REMOVE Profile Image</a>
                        </div>
                    </div><!--/.col-md-4-->
                    ...
                    <div class="col-md-4 col-sm-6 wow" data-wow-duration="1000ms" data-wow-delay="600ms">
                        ...
                        {{ Form::model($profile, array('route' => array('profiles.update', $profile->id), 'method' => 'PUT', 'files'=> true)) }}
                        ...
                        ?>
                             ...
                             {{ Form::textarea('about', null, array('class'=>'form-control chr-count', 'rows'=>'5', 'maxlength'=>'200')) }}
                             </div>
                             
                             <div class="form-group">
                            {{ Form::label('image', 'New Profile Image &nbsp; (Optional)') }}
                            {{ Form::file('image') }}
                             </div>
                    ...
                    <div class="col-md-4 col-sm-6 wow" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="center wow">
                        <!-- right -->
                        <p><a  class="btn btn-danger" onclick="return confirm('Are you sure?')" href="/delete-user/{{ $profile->user_id }}"> <i class="fa fa-exclamation-circle"></i> &nbsp; DELETE ACCOUNT</a></p>
                        </div>
                    </div><!--/.col-md-4-->
                </div><!--/.services-->
            </div><!--/.row-->
