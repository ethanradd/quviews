            ...
            <div class="row">
                <div class="features">
                    ...
                    <div class="col-md-6 col-sm-6 wow" data-wow-duration="1000ms" data-wow-delay="600ms">
                        ...
                        <a href="/reviews/create/{{ $item->id }}" title="Add your review" class="btn btn-selected">+ Add Review</a>
                        ...
                        <h2 class="margin_top_40">Add a Review</h2>
                        ...
                        {{ Form::open(array('url' => 'reviews')) }}
                             ...
                             <!-- {{ Form::label('your review', 'Your Quick Review', array('class'=>'light_gray_font')) }} -->
